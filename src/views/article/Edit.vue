<template>
  <div class="article-create-container">
    <div class="create-header">
      <h1 class="page-title">
        <span class="icon-glow">✏️</span> 编辑文章
      </h1>
    ...
    <div v-else class="create-form">
      ...
      <div class="form-group">
        ...
        <MarkdownEditor 
          ...
          v-model:images="imagesField.value"
    ...
    <div v-if="showPreview" class="preview-section">
      <h3 class="preview-title">文章内容预览</h3>
      <MarkdownRenderer :content="renderedContent" :images="imagesField.value" />
    </div>
...
import { getArticleDetail, updateArticle } from '@/api/article.ts'
...
const fetchArticleDetail = async () => {
  ...
  try {
    ...
    alert('获取文章失败：' + (error.response?.data || '未知错误'))
...
watch(() => values.images, (val) => {}, { deep: true })
</script>
